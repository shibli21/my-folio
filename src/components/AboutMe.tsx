  ...
  return (
    <Box>
      <Box my={[".5rem", "3rem"]} id="aboutMe">
        ...
        >
          <Box>
            <Text mb={4} fontSize="3xl" color="tertiary" fontWeight="700">
              Hello 👋 there,
            </Text>
            <Text mb={1} textAlign="justify" fontSize={["lg", "xl"]}>
              ...
              using Flutter and React. I have built several complex apps in
              React and Flutter , so I am confident in my ability to deliver
              excellent results.
              <br />
              <br />
              I'm a fun person who enjoys nature, pets, and programming! I am
              always looking for new ways to accomplish tasks and I love
              learning new things.
            </Text>
          </Box>
          <Box
